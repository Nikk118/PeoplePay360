                  ...
                  <tr key={t.id}>
                    <td>
                      <div style={{ display: 'flex', alignItems: 'center', gap: '0.65rem' }}>
                        <div style={{ width: '0.85rem', height: '0.85rem', borderRadius: '50%', background: t.color || 'var(--primary)' }} />
                        <span style={{ fontWeight: 700, color: 'var(--text-main)' }}>{t.name}</span>
                      </div>
                    </td>
                    <td style={{ fontFamily: 'var(--font-mono)', fontSize: '0.85rem', color: 'var(--primary)', fontWeight: 600 }}>{t.code}</td>
            ...
            <div className="glass-card" style={{ width: '100%', maxWidth: '500px', padding: '2rem' }}>
              ...
              <form onSubmit={handleCreate} style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem', marginTop: '0.5rem' }}>
                  <label style={{ display: 'flex', alignItems: 'center', gap: '0.65rem', fontSize: '0.85rem', color: 'var(--text-main)', cursor: 'pointer' }}>
